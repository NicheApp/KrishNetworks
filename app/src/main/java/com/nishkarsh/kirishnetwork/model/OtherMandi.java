...
public class OtherMandi{
    ...
    public OtherMandi(String crop_id,String district,int district_id,String hindi_name,int id,String image,double km,String last_date,
                                   double lat,double lon,String location,String market,double met,String state){
